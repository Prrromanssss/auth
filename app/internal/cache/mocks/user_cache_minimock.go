...
//go:generate minimock -i github.com/Prrromanssss/auth/internal/cache.UserCache -o user_cache_minimock.go -n UserCacheMock -p mocks
...
type UserCacheMock struct {
	...
	funcCreate          func(ctx context.Context, params model.User) (err error)
	inspectFuncCreate   func(ctx context.Context, params model.User)
	afterCreateCounter  uint64
	beforeCreateCounter uint64
	CreateMock          mUserCacheMockCreate

	funcDelete          func(ctx context.Context, params model.DeleteUserParams) (err error)
	inspectFuncDelete   func(ctx context.Context, params model.DeleteUserParams)
	afterDeleteCounter  uint64
	beforeDeleteCounter uint64
	DeleteMock          mUserCacheMockDelete

	funcGet          func(ctx context.Context, params model.GetUserParams) (resp model.GetUserResponse, err error)
	inspectFuncGet   func(ctx context.Context, params model.GetUserParams)
...
func (mmCreate *mUserCacheMockCreate) Expect(ctx context.Context, params model.User) *mUserCacheMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserCacheMockCreateParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for UserCache.Create
func (mmCreate *mUserCacheMockCreate) ExpectParamsParam2(params model.User) *mUserCacheMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.params = &params

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the UserCache.Create
func (mmCreate *mUserCacheMockCreate) Inspect(f func(ctx context.Context, params model.User)) *mUserCacheMockCreate {
...
func (mmCreate *mUserCacheMockCreate) Set(f func(ctx context.Context, params model.User) (err error)) *UserCacheMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserCacheMockCreate) When(ctx context.Context, params model.User) *UserCacheMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheMock.Create mock is already set by Set")
	}
	...
	expectation := &UserCacheMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserCacheMockCreateParams{ctx, params},
	}
...
func (mmCreate *UserCacheMock) Create(ctx context.Context, params model.User) (err error) {
	...
	mm_params := UserCacheMockCreateParams{ctx, params}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserCacheMockCreateParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmCreate.t.Errorf("UserCacheMock.Create got unexpected parameter params, want: %#v, got: %#v%s\n", *mm_want_ptrs.params, mm_got.params, minimock.Diff(*mm_want_ptrs.params, mm_got.params))
			}
	...
	mmCreate.t.Fatalf("Unexpected call to UserCacheMock.Create. %v %v", ctx, params)
	return
}
...
func (mmDelete *mUserCacheMockDelete) Expect(ctx context.Context, params model.DeleteUserParams) *mUserCacheMockDelete {
	...
	mmDelete.defaultExpectation.params = &UserCacheMockDeleteParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for UserCache.Delete
func (mmDelete *mUserCacheMockDelete) ExpectParamsParam2(params model.DeleteUserParams) *mUserCacheMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserCacheMock.Delete mock is already set by Set")
	}
	...
	mmDelete.defaultExpectation.paramPtrs.params = &params

	return mmDelete
}

// Inspect accepts an inspector function that has same arguments as the UserCache.Delete
func (mmDelete *mUserCacheMockDelete) Inspect(f func(ctx context.Context, params model.DeleteUserParams)) *mUserCacheMockDelete {
...
func (mmDelete *mUserCacheMockDelete) Set(f func(ctx context.Context, params model.DeleteUserParams) (err error)) *UserCacheMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mUserCacheMockDelete) When(ctx context.Context, params model.DeleteUserParams) *UserCacheMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserCacheMock.Delete mock is already set by Set")
	}
	...
	expectation := &UserCacheMockDeleteExpectation{
		mock:   mmDelete.mock,
		params: &UserCacheMockDeleteParams{ctx, params},
	}
...
func (mmDelete *UserCacheMock) Delete(ctx context.Context, params model.DeleteUserParams) (err error) {
	mm_atomic.AddUint64(&mmDelete.beforeDeleteCounter, 1)
	defer mm_atomic.AddUint64(&mmDelete.afterDeleteCounter, 1)

	if mmDelete.inspectFuncDelete != nil {
		mmDelete.inspectFuncDelete(ctx, params)
	}

	mm_params := UserCacheMockDeleteParams{ctx, params}
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		mm_got := UserCacheMockDeleteParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmDelete.t.Errorf("UserCacheMock.Delete got unexpected parameter params, want: %#v, got: %#v%s\n", *mm_want_ptrs.params, mm_got.params, minimock.Diff(*mm_want_ptrs.params, mm_got.params))
			}
	...
	if mmDelete.funcDelete != nil {
		return mmDelete.funcDelete(ctx, params)
	}
	mmDelete.t.Fatalf("Unexpected call to UserCacheMock.Delete. %v %v", ctx, params)
	return
}
...
func (mmGet *mUserCacheMockGet) Expect(ctx context.Context, params model.GetUserParams) *mUserCacheMockGet {
	...
	mmGet.defaultExpectation.params = &UserCacheMockGetParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for UserCache.Get
func (mmGet *mUserCacheMockGet) ExpectParamsParam2(params model.GetUserParams) *mUserCacheMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserCacheMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserCacheMockGet) Inspect(f func(ctx context.Context, params model.GetUserParams)) *mUserCacheMockGet {
...
func (mmGet *mUserCacheMockGet) Return(resp model.GetUserResponse, err error) *UserCacheMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserCacheMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &UserCacheMockGetResults{resp, err}
	return mmGet.mock
}

// Set uses given function f to mock the UserCache.Get method
func (mmGet *mUserCacheMockGet) Set(f func(ctx context.Context, params model.GetUserParams) (resp model.GetUserResponse, err error)) *UserCacheMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserCacheMockGet) When(ctx context.Context, params model.GetUserParams) *UserCacheMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserCacheMock.Get mock is already set by Set")
	}
	...
	expectation := &UserCacheMockGetExpectation{
		mock:   mmGet.mock,
		params: &UserCacheMockGetParams{ctx, params},
	}
...
func (e *UserCacheMockGetExpectation) Then(resp model.GetUserResponse, err error) *UserCacheMock {
	e.results = &UserCacheMockGetResults{resp, err}
	return e.mock
}
...
func (mmGet *UserCacheMock) Get(ctx context.Context, params model.GetUserParams) (resp model.GetUserResponse, err error) {
	...
	mm_params := UserCacheMockGetParams{ctx, params}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := UserCacheMockGetParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmGet.t.Errorf("UserCacheMock.Get got unexpected parameter params, want: %#v, got: %#v%s\n", *mm_want_ptrs.params, mm_got.params, minimock.Diff(*mm_want_ptrs.params, mm_got.params))
			}
	...
	mmGet.t.Fatalf("Unexpected call to UserCacheMock.Get. %v %v", ctx, params)
	return
}
