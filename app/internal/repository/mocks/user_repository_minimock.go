...
//go:generate minimock -i github.com/Prrromanssss/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Expect(ctx context.Context, params model.DeleteUserParams) *mUserRepositoryMockDeleteUser {
	...
	mmDeleteUser.defaultExpectation.params = &UserRepositoryMockDeleteUserParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for UserRepository.DeleteUser
func (mmDeleteUser *mUserRepositoryMockDeleteUser) ExpectParamsParam2(params model.DeleteUserParams) *mUserRepositoryMockDeleteUser {
	if mmDeleteUser.mock.funcDeleteUser != nil {
		mmDeleteUser.mock.t.Fatalf("UserRepositoryMock.DeleteUser mock is already set by Set")
	}
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Inspect(f func(ctx context.Context, params model.DeleteUserParams)) *mUserRepositoryMockDeleteUser {
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Set(f func(ctx context.Context, params model.DeleteUserParams) (err error)) *UserRepositoryMock {
	if mmDeleteUser.defaultExpectation != nil {
...
// Then helper
func (mmDeleteUser *mUserRepositoryMockDeleteUser) When(ctx context.Context, params model.DeleteUserParams) *UserRepositoryMockDeleteUserExpectation {
	if mmDeleteUser.mock.funcDeleteUser != nil {
		mmDeleteUser.mock.t.Fatalf("UserRepositoryMock.DeleteUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockDeleteUserExpectation{
		...
		params: &UserRepositoryMockDeleteUserParams{ctx, params},
	}
...
func (mmDeleteUser *UserRepositoryMock) DeleteUser(ctx context.Context, params model.DeleteUserParams) (err error) {
	...
	mm_params := UserRepositoryMockDeleteUserParams{ctx, params}
	...
	if mmDeleteUser.DeleteUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockDeleteUserParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmDeleteUser.t.Errorf("UserRepositoryMock.DeleteUser got unexpected parameter params, want: %#v, got: %#v%s\n", *mm_want_ptrs.params, mm_got.params, minimock.Diff(*mm_want_ptrs.params, mm_got.params))
			}
	...
	mmDeleteUser.t.Fatalf("Unexpected call to UserRepositoryMock.DeleteUser. %v %v", ctx, params)
	return
}
...
func (mmGetUser *mUserRepositoryMockGetUser) Expect(ctx context.Context, params model.GetUserParams) *mUserRepositoryMockGetUser {
	...
	mmGetUser.defaultExpectation.params = &UserRepositoryMockGetUserParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for UserRepository.GetUser
func (mmGetUser *mUserRepositoryMockGetUser) ExpectParamsParam2(params model.GetUserParams) *mUserRepositoryMockGetUser {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
...
func (mmGetUser *mUserRepositoryMockGetUser) Inspect(f func(ctx context.Context, params model.GetUserParams)) *mUserRepositoryMockGetUser {
...
func (mmGetUser *mUserRepositoryMockGetUser) Return(resp model.GetUserResponse, err error) *UserRepositoryMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
	...
	mmGetUser.defaultExpectation.results = &UserRepositoryMockGetUserResults{resp, err}
	return mmGetUser.mock
}

// Set uses given function f to mock the UserRepository.GetUser method
func (mmGetUser *mUserRepositoryMockGetUser) Set(f func(ctx context.Context, params model.GetUserParams) (resp model.GetUserResponse, err error)) *UserRepositoryMock {
	if mmGetUser.defaultExpectation != nil {
...
// Then helper
func (mmGetUser *mUserRepositoryMockGetUser) When(ctx context.Context, params model.GetUserParams) *UserRepositoryMockGetUserExpectation {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockGetUserExpectation{
		mock:   mmGetUser.mock,
		params: &UserRepositoryMockGetUserParams{ctx, params},
	}
...
func (e *UserRepositoryMockGetUserExpectation) Then(resp model.GetUserResponse, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetUserResults{resp, err}
	return e.mock
}
...
func (mmGetUser *UserRepositoryMock) GetUser(ctx context.Context, params model.GetUserParams) (resp model.GetUserResponse, err error) {
	...
	mm_params := UserRepositoryMockGetUserParams{ctx, params}
	...
	if mmGetUser.GetUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockGetUserParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmGetUser.t.Errorf("UserRepositoryMock.GetUser got unexpected parameter params, want: %#v, got: %#v%s\n", *mm_want_ptrs.params, mm_got.params, minimock.Diff(*mm_want_ptrs.params, mm_got.params))
			}
	...
	mmGetUser.t.Fatalf("Unexpected call to UserRepositoryMock.GetUser. %v %v", ctx, params)
	return
}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Expect(ctx context.Context, params model.UpdateUserParams) *mUserRepositoryMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserRepositoryMockUpdateUserParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for UserRepository.UpdateUser
func (mmUpdateUser *mUserRepositoryMockUpdateUser) ExpectParamsParam2(params model.UpdateUserParams) *mUserRepositoryMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Inspect(f func(ctx context.Context, params model.UpdateUserParams)) *mUserRepositoryMockUpdateUser {
...
// Then helper
func (mmUpdateUser *mUserRepositoryMockUpdateUser) When(ctx context.Context, params model.UpdateUserParams) *UserRepositoryMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateUserExpectation{
		...
		params: &UserRepositoryMockUpdateUserParams{ctx, params},
	}
...
func (mmUpdateUser *UserRepositoryMock) UpdateUser(ctx context.Context, params model.UpdateUserParams) (err error) {
	...
	mm_params := UserRepositoryMockUpdateUserParams{ctx, params}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateUserParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmUpdateUser.t.Errorf("UserRepositoryMock.UpdateUser got unexpected parameter params, want: %#v, got: %#v%s\n", *mm_want_ptrs.params, mm_got.params, minimock.Diff(*mm_want_ptrs.params, mm_got.params))
			}
	...
	mmUpdateUser.t.Fatalf("Unexpected call to UserRepositoryMock.UpdateUser. %v %v", ctx, params)
	return
}
